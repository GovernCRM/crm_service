...
class Appointment(models.Model):
    appointment_uuid = models.UUIDField(db_index=True, default=uuid.uuid4, editable=False)
    ...
    invitee_uuids = ArrayField(models.UUIDField(), blank=True, null=True,help_text='List of Users invited to the appointment.')
    notes = models.CharField( max_length=500, help_text='Notes', blank=True, null=True)
